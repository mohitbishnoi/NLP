# -*- coding: utf-8 -*-
"""
Created on Wed Jun 19 12:26:56 2019
...
#Loading Data
data=pd.read_csv("E:/Office files/course/NLP/Case Study Sentiment Analysis/sentiment-analysis-on-movie-reviews/train.tsv", sep='\t')
data.head()
...
X_train, X_test, y_train, y_test = train_test_split(text_counts, data['Sentiment'], test_size=0.2, random_state=11)
